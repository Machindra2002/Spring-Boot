...
import mypackage.service.FileStorageService;
...
public class FileController {
    ...
    public Employee AddEmployee(@RequestParam("file") MultipartFile file,@RequestParam("employee_name")String employee_name,@RequestParam("employee_id")int employee_id) {
        String fileName = fileStorageService.storeFile(file);
        Employee e=new Employee(employee_id,employee_name,fileName);
