...
//		return studservice.AddStudentDetails(student);
//	}
//
...
//	}
	...
	public StudentDetails AddNewStudentDetails(@RequestParam("student_name") String student_name, @RequestParam("student_code") String student_code,
			@RequestParam("email_address") String email_address, @RequestParam("mobile_number") String mobile_number,
			@RequestParam("file") MultipartFile file, @RequestParam("city") String city) {
		String fileName = fileStorageService.storeFile(file);
...
//	public StudentDetails CheckLogin(@RequestBody StudentDetails sd) {
//		System.out.println(sd.getStudent_code()+" "+sd.getPassword());
//		return studservice.GetStudentLoginDetails(sd);
//	}
